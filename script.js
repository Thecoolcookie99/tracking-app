...
//got chatgpt to help me with this
...
//chatgpt helped with this as well, although it just checks if there is hours, if there is it shows hours, if not it doesnt
if (durationHours > 0) {
